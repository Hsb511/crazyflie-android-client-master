...
public class FlightDataView extends LinearLayout {
    ...
    public FlightDataView(Context context, AttributeSet attrs) {
        ...
        //initialize
        mTextView_pitch.setText(format(R.string.pitch_pos, 0.0));
        mTextView_roll.setText(format(R.string.roll_pos, 0.0));
        mTextView_thrust.setText(format(R.string.thrust_pos, 0.0));
        mTextView_yaw.setText(format(R.string.yaw_pos, 0.0));
    }
    ...
    public void updateFlightData(float pitch, float roll, float thrust, float yaw) {
        if (pitch>=0) {
            mTextView_pitch.setText(format(R.string.pitch_pos, round(pitch)));
        } else {
            mTextView_pitch.setText(format(R.string.pitch_neg, round(pitch)));
        }
        if (roll>=0) {
            mTextView_roll.setText(format(R.string.roll_pos, round(roll)));
        } else {
            mTextView_roll.setText(format(R.string.roll_neg, round(roll)));
        }
        if (thrust>=0) {
            mTextView_thrust.setText(format(R.string.thrust_pos, round(thrust)));
        } else {
            mTextView_thrust.setText(format(R.string.thrust_neg, round(thrust)));
        }
        if (yaw>=0) {
            mTextView_yaw.setText(format(R.string.yaw_pos, round(yaw)));
        } else {
            mTextView_yaw.setText(format(R.string.yaw_neg, round(yaw)));
        }
