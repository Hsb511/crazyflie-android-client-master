...
public class MainActivity extends Activity {
    ...
    private void initializeMenuButtons() {
        ...
        ImageButton layoutTAFButton = (ImageButton) findViewById(R.id.button_layout_taf);
        layoutTAFButton.setOnClickListener(new View.OnClickListener() {

            @Override
            public void onClick(View v) {
                Intent intent = new Intent(MainActivity.this, TakeOffAndFigures.class);
                startActivity(intent);
            }
        });
    }
